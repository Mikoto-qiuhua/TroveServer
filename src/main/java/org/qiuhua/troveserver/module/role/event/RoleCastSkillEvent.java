...
public class RoleCastSkillEvent implements PlayerEvent, CancellableEvent {
    ...
    public RoleCastSkillEvent(RPGPlayer rpgPlayer , RoleData roleData, String skillName){
