...
public class RoleTakeEquipEvent implements PlayerEvent, CancellableEvent {
    ...
    public RoleTakeEquipEvent(RPGPlayer rpgPlayer, RoleData roleData, EquipSlotData equipSlotData, ItemStack itemStack){
